  ...
  <div class="container mt-4">
    <div class="row justify-content-start">
      ...
      <div class="image-select-container col-6 col-md-3 d-flex justify-content-center">
        <a href="javascript:void(0);" class="image-box card align-items-center menu-pic border-0 food-pic" style="width: 17rem; border-radius: 25px;" >
      ...
      <div class="image-select-container col-6 col-md-3 d-flex justify-content-center">
        <a href="javascript:void(0);" class="image-box card align-items-center menu-pic border-0 food-pic" style="width: 17rem; border-radius: 25px;" onclick="toggleSelect(this)">
          ...
          <div class="card-body">
            <p class="food-font" style="padding-top: 40px;">Latte</p>
...
<footer><img src="./assets/img/bin.png" class="floating-circle" alt="Circle Image"></footer>
