  ...
  <?php foreach ($menus as $menu): ?>
    <div class="col-6 col-md-3 d-flex justify-content-center">
      <a href="../../fontend/main/menu_detail.php?id=<?= $menu['menu_id'] ?>" class="card align-items-center menu-pic border-0 food-pic" style="width: 17rem; border-radius: 25px; margin-top: 30px;">
         <img src="../../backoffice/uploads/imgmenu/<?= htmlspecialchars($menu['image']) ?>" class="card-img-top mt-3" style="width: 200px;" height="200px" alt="...">
        <div class="card-body">
...
<footer><a href="../../fontend/cart/listcart.php"><img src="../../assets/img/plus.png" class="floating-circle" alt="Circle Image"></a></footer>
